...
class _HotelHomeScreenState extends State<HotelHomeScreen>
  ...
  final Uri url = Uri.parse("http://10.0.2.2:8000/api/emdee/emdee_blog_post/");
  ...
  _retrieveEmdee() async {
    ...
    print('response hhhhhhhhhhhhhhhhhhhhhhhh');
  }
